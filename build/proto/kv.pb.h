...
inline void kv::set_key(const char* value) {
  ...
  key_->assign(value);
  // @@protoc_insertion_point(field_set_char:kv.key)
}
inline void kv::set_key(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:kv.key)
}
inline ::std::string* kv::mutable_key() {
  ...
  // @@protoc_insertion_point(field_mutable:kv.key)
  return key_;
}
...
inline void kv::set_allocated_key(::std::string* key) {
  ...
  // @@protoc_insertion_point(field_set_allocated:kv.key)
}
...
inline void kv::set_value(const char* value) {
  ...
  value_->assign(value);
  // @@protoc_insertion_point(field_set_char:kv.value)
}
inline void kv::set_value(const void* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:kv.value)
}
inline ::std::string* kv::mutable_value() {
  ...
  // @@protoc_insertion_point(field_mutable:kv.value)
  return value_;
}
...
inline void kv::set_allocated_value(::std::string* value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:kv.value)
}
